...
router.post('/inventory/delete', auth.hasRole('admin'), controller.deleteInventories);
...
router.delete('/:companyId/store/:storeId/inventory/:inventoryId', auth.hasRole('admin'), controller.deleteInventory);
