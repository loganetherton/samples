...
// Check a balance from UI and perform autosell
router.post('/checkBalanceFromUi', auth.isAuthenticated(), controller.checkBalanceFromUi);
// Update card balance
...
// Reject inventories
router.post('/adjustments', auth.hasRole('admin'), controller.adjustments);
// Resell cards
