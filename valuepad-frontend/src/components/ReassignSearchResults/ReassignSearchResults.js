...
import styles from './ReassignSearchResults.scss';

/**
 * Reassign order search results
 */
export default class ReassignSearchResults extends Component {
  static propTypes = {
